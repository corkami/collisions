...
# a simple ZipFile hack, line 1887
# - saves the extra field only in the Local File Directory.
# - the copy in the Central Directory is discarded.
...
class ZipFile:
    ...
    def _write_end_record(self):
        for zinfo in self.filelist:         # write central directory
            ...
            extra_data = b"" # PATCH HERE - was previously zinfo.extra
            min_version = 0
            if extra:
